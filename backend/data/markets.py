"""Market data types and fetching — unified interface for BTC + weather markets."""
import logging
...
@dataclass
class MarketData:
    """Structured market data — generic wrapper for any market type."""
    platform: str
    ticker: str
    title: str
    category: str
...
async def fetch_all_markets(**kwargs) -> List[MarketData]:
    """Fetch all markets — currently BTC 5-min markets."""
